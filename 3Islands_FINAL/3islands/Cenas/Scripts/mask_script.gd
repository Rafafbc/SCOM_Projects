...
@export var next_level_path: String = "res://Scenes/Scene1/Virtual_Guy-scene1.tscn"
...
func _on_body_entered(body: Node2D) -> void:
	...
	if body.name == "Player" and GlobalVar.Macas3 == 15:  # Certifique-se de que o nome do jogador é "Player".
